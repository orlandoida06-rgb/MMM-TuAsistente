...
bytype: dict[int, dict[int, str | tuple[str]]] = { 0: {0: 'SYN_REPORT', 1: 'SYN_CONFIG', 2: 'SYN_MT_REPORT', 3: 'SYN_DROPPED', 15: 'SYN_MAX', 16: 'SYN_CNT'},
  1: { 0: 'KEY_RESERVED',
       1: 'KEY_ESC',
       2: 'KEY_1',
       3: 'KEY_2',
...
keys: dict[int, str | tuple[str]] = { 0: 'KEY_RESERVED',
  1: 'KEY_ESC',
  2: 'KEY_1',
  3: 'KEY_2',
  4: 'KEY_3',
...
KEY: dict[int, str | tuple[str]] = { 0: 'KEY_RESERVED',
  1: 'KEY_ESC',
  2: 'KEY_1',
  3: 'KEY_2',
  4: 'KEY_3',
...
ABS: dict[int, str | tuple[str]] = { 0: 'ABS_X',
  1: 'ABS_Y',
  2: 'ABS_Z',
  3: 'ABS_RX',
  4: 'ABS_RY',
...
REL: dict[int, str | tuple[str]] = { 0: 'REL_X',
  1: 'REL_Y',
  2: 'REL_Z',
  3: 'REL_RX',
  4: 'REL_RY',
...
SW: dict[int, str | tuple[str]] = { 0: 'SW_LID',
  1: 'SW_TABLET_MODE',
  2: 'SW_HEADPHONE_INSERT',
  3: ('SW_RADIO', 'SW_RFKILL_ALL'),
  4: 'SW_MICROPHONE_INSERT',
...
MSC: dict[int, str | tuple[str]] = { 0: 'MSC_SERIAL',
  1: 'MSC_PULSELED',
  2: 'MSC_GESTURE',
  3: 'MSC_RAW',
  4: 'MSC_SCAN',
...
LED: dict[int, str | tuple[str]] = { 0: 'LED_NUML',
  1: 'LED_CAPSL',
  2: 'LED_SCROLLL',
  3: 'LED_COMPOSE',
  4: 'LED_KANA',
...
BTN: dict[int, str | tuple[str]] = { 256: ('BTN_0', 'BTN_MISC'),
  257: 'BTN_1',
  258: 'BTN_2',
  259: 'BTN_3',
  260: 'BTN_4',
...
REP: dict[int, str | tuple[str]] = {0: 'REP_DELAY', 1: ('REP_MAX', 'REP_PERIOD'), 2: 'REP_CNT'}

SND: dict[int, str | tuple[str]] = {0: 'SND_CLICK', 1: 'SND_BELL', 2: 'SND_TONE', 7: 'SND_MAX', 8: 'SND_CNT'}

ID: dict[int, str | tuple[str]] = {0: 'ID_BUS', 1: 'ID_VENDOR', 2: 'ID_PRODUCT', 3: 'ID_VERSION'}

EV: dict[int, str | tuple[str]] = { 0: 'EV_SYN',
  1: 'EV_KEY',
  2: 'EV_REL',
  3: 'EV_ABS',
  4: 'EV_MSC',
...
BUS: dict[int, str | tuple[str]] = { 1: 'BUS_PCI',
  2: 'BUS_ISAPNP',
  3: 'BUS_USB',
  4: 'BUS_HIL',
  5: 'BUS_BLUETOOTH',
...
SYN: dict[int, str | tuple[str]] = {0: 'SYN_REPORT', 1: 'SYN_CONFIG', 2: 'SYN_MT_REPORT', 3: 'SYN_DROPPED', 15: 'SYN_MAX', 16: 'SYN_CNT'}

FF: dict[int, str | tuple[str]] = { 80: ('FF_EFFECT_MIN', 'FF_RUMBLE'),
  81: 'FF_PERIODIC',
  82: 'FF_CONSTANT',
  83: 'FF_SPRING',
  84: 'FF_FRICTION',
...
UI_FF: dict[int, str | tuple[str]] = {1: 'UI_FF_UPLOAD', 2: 'UI_FF_ERASE'}

FF_STATUS: dict[int, str | tuple[str]] = {0: 'FF_STATUS_STOPPED', 1: ('FF_STATUS_MAX', 'FF_STATUS_PLAYING')}

INPUT_PROP: dict[int, str | tuple[str]] = { 0: 'INPUT_PROP_POINTER',
  1: 'INPUT_PROP_DIRECT',
